...
const cargarTestTema1 = async () => {
  try {
    ...
    const testData = JSON.parse(
      readFileSync(join(__dirname, '../data/test-tema1-introduccion.json'), 'utf-8')
    );
    ...
    if (testExistente) {
      console.log('⚠️  Ya existe un test para este curso. Actualizando...');
